...
exports.main = exports.myFirstAsyncIO = void 0;
...
const main = (path) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const numberOfNewlines = yield (0, exports.myFirstAsyncIO)(path);
